        ...
        @foreach ($customers as $customer)
            <tr>
                ...
                <td>
                    ...
                    {!! Form::submit('Delete', ['class' => 'btn btn-danger','onClick'=> 'return confirm("Deleting the customer would delete all the corresponding stocks and investments of the customer selected. Would you like to continue?");']) !!}
                    {!! Form::close() !!}
                </td>
            </tr>
        @endforeach
